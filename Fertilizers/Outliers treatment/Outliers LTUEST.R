...
input_file  <- "D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Test cluster/input/Data pour outliers treat/prepared_objects_FERT_GC_LTUEST.RDS"
output_file <- "D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Test cluster/input/Data_for_allocation/prepared_list_FERT_GC_LTUEST.RDS"
