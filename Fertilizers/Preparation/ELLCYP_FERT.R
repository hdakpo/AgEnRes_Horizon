...
share_path <- "D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Test cluster/input/SHARE/"
output_path <- "D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Test cluster/input/Data pour outliers treat/"
# Chargement des données principales
MYDATA <- readRDS("D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Test cluster/input/Data_2017_2022/ELLCYP.RDS")
...
share_output_file <- paste0(share_path, "share_GC_FERT_LTUEST.csv")
...
CCEROTHALL_name <- c( "CCEROTHN")
CPOTALL_name <- c("CPOT", "CPOTST", "CPOTOTH")
CVEGFLOW_name <- "SE046"
CPERWOUTWINE_name <- "SE054"
CARAOTHALL_name <- c( "CSOYA", "SE050", "CARAOTHN")
...
saveRDS(mylist_for_model, file = paste0(output_path, "prepared_objects_FERT_GC_LTUEST.RDS"))
...
# Chargement des données principales
MYDATA <- readRDS("D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Test cluster/input/Data_2017_2022/LTUEST.RDS")
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(share_path, "share_LS_FERT_LTUEST.csv")
write.csv2(res, share_output_file)
...
saveRDS(mylist_for_model, file = paste0(output_path, "prepared_objects_FERT_LS_LTUEST.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(share_path, "share_MX_FERT_LTUEST.csv")
write.csv2(res, share_output_file)

# Regroupement pour allocation
cname_alloc_mx <- c("CWHTC" , "CWHTD", "CMZ", "CBRL", "COAT", "CCEROTHALL",
                    "CRAPE", "CSNFL",
                    "CPERWOUTWINE", 
                    "CFODDER",
                    "CARAOTHALL")

CCROPOBS_name <- c("CWHTC" , "CWHTD", "CMZ", "CBRL", "COAT", 
                   "CRAPE", "CSNFL")

# Création des agrégées
CCEROTHALL_name <- c( "CRYE", "CRICE", "CCEROTHN")
CPERWOUTWINE_name <- "SE054"
CARAOTHALL_name <- c("CPOT", "CPOTST", "CPOTOTH","CSOYA",  "CSUGBT", "SE046",  "SE050", "CARAOTHN")
CFODDER_name <- "SE071"
...
saveRDS(mylist_for_model, file = paste0(output_path, "prepared_objects_FERT_MX_LTUEST.RDS"))
