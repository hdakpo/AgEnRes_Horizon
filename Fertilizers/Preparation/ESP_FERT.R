...
MYDATA <- readRDS("D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Test cluster/input/Data_2017_2022/ESP.RDS")
...
share_output_file <- paste0(output_path, "share_GC_FERT_ESP.csv")
...
saveRDS(mylist_for_model, file = paste0(output_path, "prepared_objects_FERT_GC_ESP.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_LS_FERT_ESP.csv")
write.csv2(res, share_output_file)

# Regroupement pour allocation
cname_alloc_ls <- c("CWHTALL", "CMZ", "CBRL", "CRYE", "COAT", "CCEROTHALL",
                    "CPERWOUTWINE", 
                    "CFODDER",
                    "CARAOTHALL")
...
saveRDS(mylist_for_model, file = paste0(output_path, "prepared_objects_FERT_LS_ESP.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_MX_FERT_ESP.csv")
write.csv2(res, share_output_file)
...
saveRDS(mylist_for_model, file = paste0(output_path, "prepared_objects_FERT_MX_ESP.RDS"))
