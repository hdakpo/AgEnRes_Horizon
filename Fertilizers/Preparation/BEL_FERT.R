...
MYDATA <- readRDS("D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Test cluster/input/Data_2017_2022/BEL.RDS")
...
share_output_file <- paste0(output_path, "share_GC_FERT_BEL.csv")
...
saveRDS(mylist_for_model, file = paste0(output_path, "prepared_objects_FERT_GC_BEL.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_LS_FERT_BEL.csv")
write.csv2(res, share_output_file)
...
CCROPOBS_name <- c("CMZ", "CBRL","CSUGBT")
...
saveRDS(mylist_for_model, file = paste0(output_path, "prepared_objects_FERT_LS_BEL.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_MX_FERT_BEL.csv")
write.csv2(res, share_output_file)
...
saveRDS(mylist_for_model, file = paste0(output_path, "prepared_objects_FERT_MX_BEL.RDS"))
