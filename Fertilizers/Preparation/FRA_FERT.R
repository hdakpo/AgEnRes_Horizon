...
MYDATA <- readRDS("D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Test cluster/input/Data_2017_2022/FRA.RDS")
...
output_path <- "D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Test cluster/input/SHARE/"
share_output_file <- paste0(output_path, "share_GC_FERT_FRA.csv")
...
saveRDS(mylist_for_model, file = paste0(output_path, "prepared_objects_FERT_GC_FRA.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_LS_FERT_FRA.csv")
write.csv2(res, share_output_file)
...
output_path <- "D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Test cluster/input/Data pour outliers treat/"
saveRDS(mylist_for_model, file = paste0(output_path, "prepared_objects_FERT_LS_FRA.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_MX_FERT_FRA.csv")
write.csv2(res, share_output_file)
...
CCROPOBS_name <- c("CMZ", "CBRL","CRAPE","CSUGBT")
...
output_path <- "D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Test cluster/input/Data pour outliers treat/"
saveRDS(mylist_for_model, file = paste0(output_path, "prepared_objects_FERT_MX_FRA.RDS"))
