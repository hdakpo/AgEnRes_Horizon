...
MYDATA <- readRDS("D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Test cluster/input/Data_2017_2022/ITA.RDS")
...
share_output_file <- paste0(output_path, "share_GC_FERT_ITA.csv")
...
CCROPOBS_name <- c( "CWHTC", "CWHTD", "CMZ", "CBRL", "COAT", "CRICE","CPOT", "CSOYA")
...
saveRDS(mylist_for_model, file = paste0(output_path, "prepared_objects_FERT_GC_ITA.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_LS_FERT_ITA.csv")
write.csv2(res, share_output_file)
...
CCROPOBS_name <- c("CWHTC", "CWHTD", "CMZ", "CBRL", "COAT", "CSOYA")
...
saveRDS(mylist_for_model, file = paste0(output_path, "prepared_objects_FERT_LS_ITA.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_MX_FERT_ITA.csv")
write.csv2(res, share_output_file)
...
saveRDS(mylist_for_model, file = paste0(output_path, "prepared_objects_FERT_MX_ITA.RDS"))
