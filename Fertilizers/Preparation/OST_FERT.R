...
MYDATA <- readRDS("D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Test cluster/input/Data_2017_2022/OST.RDS")
...
share_output_file <- paste0(output_path, "share_GC_FERT_OST.csv")
write.csv2(res, share_output_file)

# Regroupement pour allocation
cname_alloc_gc <- c("CWHTC", "CWHTD", "CMZ", "CBRL", "CRYE", "COAT", "CCEROTHALL",
                    "CPOTALL",
                    "CSUGBT", "CRAPE", "CSNFL", "CSOYA",
                    "CVEGFLOW",
                    "CARAOTHALL")

CCROPOBS_name <- c("CWHTC", "CWHTD", "CMZ", "CBRL", "CRYE", "COAT",
                   "CSUGBT", "CRAPE", "CSNFL", "CSOYA")
...
saveRDS(mylist_for_model, file = paste0(output_path, "prepared_objects_FERT_GC_OST.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_LS_FERT_OST.csv")
write.csv2(res, share_output_file)
...
saveRDS(mylist_for_model, file = paste0(output_path, "prepared_objects_FERT_LS_OST.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_MX_FERT_OST.csv")
write.csv2(res, share_output_file)
...
saveRDS(mylist_for_model, file = paste0(output_path, "prepared_objects_FERT_MX_OST.RDS"))
