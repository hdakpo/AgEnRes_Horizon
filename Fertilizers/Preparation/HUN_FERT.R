...
MYDATA <- readRDS("D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Test cluster/input/Data_2017_2022/HUN.RDS")
...
share_output_file <- paste0(output_path, "share_GC_FERT_HUN.csv")
...
CVEGFLOW_name <- "SE046"
CARAOTHALL_name <- c("CPOT", "CPOTST", "CPOTOTH", "CSUGBT", "SE054", "SE050", "CARAOTHN")
...
saveRDS(mylist_for_model, file = paste0(output_path, "prepared_objects_FERT_GC_HUN.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_LS_FERT_HUN.csv")
write.csv2(res, share_output_file)
...
saveRDS(mylist_for_model, file = paste0(output_path, "prepared_objects_FERT_LS_HUN.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_MX_FERT_HUN.csv")
write.csv2(res, share_output_file)
...
saveRDS(mylist_for_model, file = paste0(output_path, "prepared_objects_FERT_MX_HUN.RDS"))
