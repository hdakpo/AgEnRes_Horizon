...
MYDATA <- readRDS("D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Fuels/input/Data_2017_2022/SVK.RDS")
...
share_output_file <- paste0(output_path, "share_GC_FUELS_SVK.csv")
write.csv2(res, share_output_file)

# Regroupement pour allocation
cname_alloc_gc <- c("CWHTC", "CWHTD", "CBRL", "CMZ", "CCEROTHALL",
                    "CPOT",  "CPOTOTH",
                    "CSUGBT", "CRAPE", "CSNFL", "CSOYA", "CVEGFLOW",
                    "CGRSXRG", "CRG", "CFODDOTHALL", 
                    "CARAOTHALL")

CCROPOBS_name <- c("CWHTC", "CWHTD", "CBRL", "CMZ", 
                   "CPOT", 
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_GC_SVK.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_LS_FUELS_SVK.csv")
write.csv2(res, share_output_file)
...
CCROPOBS_name <- c("CBRL", "CGRSTMP", "CGRSXRG", "CRG")
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_LS_SVK.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_MX_FUELS_SVK.csv")
write.csv2(res, share_output_file)
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_MX_SVK.RDS"))
