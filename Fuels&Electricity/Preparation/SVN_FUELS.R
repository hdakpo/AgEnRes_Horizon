...
MYDATA <- readRDS("D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Fuels/input/Data_2017_2022/SVN.RDS")
...
share_output_file <- paste0(output_path, "share_GC_FUELS_SVN.csv")
write.csv2(res, share_output_file)

# Regroupement pour allocation
cname_alloc_gc <- c("CWHTALL", "CBRL", "CMZ",  "CCEROTHALL",
                    "CPOTALL", 
                    "CRAPE", "COILSEEDOTH",
...
CWINE_name <- "SE050"
CCEROTHALL_name <- c("CRYE", "CRICE", "COAT", "CCEROTHN")
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_GC_SVN.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_LS_FUELS_SVN.csv")
write.csv2(res, share_output_file)
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_LS_SVN.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_MX_FUELS_SVN.csv")
write.csv2(res, share_output_file)
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_MX_SVN.RDS"))
