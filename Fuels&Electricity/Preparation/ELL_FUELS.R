...
MYDATA <- readRDS("D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Fuels/input/Data_2017_2022/ELL.RDS")
...
share_output_file <- paste0(output_path, "share_GC_FUELS_ELL.csv")
write.csv2(res, share_output_file)

# Regroupement pour allocation
cname_alloc_gc <- c("CWHTC", "CWHTD", "CMZ", "CBRL", "CRICE", "CCEROTHALL",
                    "CPOT", "CPOTOTH", 
                    "CSNFL",
...
CCROPOBS_name <- c("CWHTC", "CWHTD", "CMZ", "CBRL", "CRICE",
                   "CSNFL", "CPOT")

# Création des agrégées
CCEROTHALL_name <- c("CRYE", "COAT", "CCEROTHN")
CPOTOTH_name <- c("CPOTST", "CPOTOTH")
CVEGFLOW_name <- "SE046"
CPERWOUTWINE_name <- "SE054"
CARAOTHALL_name <- c("CSUGBT", "CRAPE", "CSOYA", "SE050", "CARAOTHN")
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_GC_ELL.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_LS_FUELS_ELL.csv")
write.csv2(res, share_output_file)
...
CPERWOUTWINE_name  <- "SE054"
CARAOTHALL_name <- c("CPOT", "CPOTST", "CPOTOTH", "CSUGBT", "CRAPE","CSOYA", "CSNFL", "SE046", "SE050", "CARAOTHN")
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_LS_ELL.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_MX_FUELS_ELL.csv")
write.csv2(res, share_output_file)
...
CCROPOBS_name <- c("CWHTC", "CWHTD", "CMZ", "CBRL", "COAT", "CGRSXRG", "CRG")
...
CPERWOUTWINE_name <- "SE054"
CWINE_name <- "SE050"
CARAOTHALL_name <- c("CPOT","CPOTST", "CPOTOTH", "CSUGBT", "CRAPE", "CSNFL", "CSOYA", "CARAOTHN")
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_MX_ELL.RDS"))
