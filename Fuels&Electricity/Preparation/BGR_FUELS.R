...
MYDATA <- readRDS("D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Fuels/input/Data_2017_2022/BGR.RDS")
...
share_output_file <- paste0(output_path, "share_GC_FUELS_BGR.csv")
...
cname_alloc_gc <- c("CWHTALL", "CMZ", "CBRL", "CCEROTHALL",
                    "CPOTALL",
                    "COILSEEDOTH", "CSNFL", 
                    "CVEGFLOW", "CFODDOTHALL", "CARAOTHALL")
...
CVEGFLOW_name <- "SE046"
COILSEEDOTH_name <- c("CRAPE" , "CSOYA")
CFODDOTHALL_name <- c("CFODRTBR", "CRG", "CGRSTMP", "CGRSXRG", "CFODDOTHN")
CARAOTHALL_name <- c("CSUGBT", "SE054", "SE050", "CARAOTHN")
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_GC_BGR.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_LS_FUELS_BGR.csv")
write.csv2(res, share_output_file)

# Regroupement pour allocation
cname_alloc_ls <- c("CWHTALL", "CMZ", "CBRL", "CCEROTHALL",
                    "COILSEEDALL",
                    "CGRSXRG", "CRG", "CFODDOTHALL",
                    "CARAOTHALL")

CCROPOBS_name <- c("CMZ", "CBRL", "CGRSXRG", "CRG")
...
CFODDOTHALL_name <- c("CFODRTBR", "CGRSTMP", "CFODDOTHN")
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_LS_BGR.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_MX_FUELS_BGR.csv")
write.csv2(res, share_output_file)
...
cname_alloc_mx <- c("CWHTALL", "CMZ", "CBRL", "CCEROTHALL",
                    ...
                    "CFODDOTHALL", "CGRSXRG", "CRG",
                    "CARAOTHALL")

CCROPOBS_name <- c("CMZ", "CBRL","CSNFL", "CGRSXRG", "CRG")
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_MX_BGR.RDS"))
