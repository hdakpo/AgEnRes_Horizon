...
MYDATA <- readRDS("D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Fuels/input/Data_2017_2022/DEU.RDS")
...
share_output_file <- paste0(output_path, "share_GC_FUELS_DEU.csv")
...
CFODDOTHALL_name <- c("CGRSTMP", "CFODRTBR", "CRG", "CFODDOTHN")
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_GC_DEU.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_LS_FUELS_DEU.csv")
write.csv2(res, share_output_file)
...
CCROPOBS_name <- c( "CMZ", "CBRL", "CRYE", "CGRSXRG")
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_LS_DEU.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_MX_FUELS_DEU.csv")
write.csv2(res, share_output_file)
...
CCROPOBS_name <- c("CMZ", "CBRL", "CRYE", "COAT", "CSUGBT", "CGRSXRG")
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_MX_DEU.RDS"))
