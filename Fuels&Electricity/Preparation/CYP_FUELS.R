...
MYDATA <- readRDS("D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Fuels/input/Data_2017_2022/CYP.RDS")
...
share_output_file <- paste0(output_path, "share_GC_FUELS_CYP.csv")
write.csv2(res, share_output_file)

# Regroupement pour allocation
cname_alloc_gc <- c("CWHTC", "CWHTD", "CBRL", "CCEROTHALL",
                    "CPOT", "CPOTOTH", 
                    "CPERWOUTWINE", "CFODDOTHALL",
                    "CVEGFLOW", "CARAOTHALL")

CCROPOBS_name <- c("CWHTC", "CWHTD", "CBRL",
                   "CPOT")
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_GC_CYP.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_LS_FUELS_CYP.csv")
write.csv2(res, share_output_file)
...
CCROPOBS_name <- c("CBRL", "CGRSTMP", "CGRSXRG")
...
CPERWOUTWINE_name <- "SE054"
CWINE_name <- "SE050"
CARAOTHALL_name <- c("CPOT", "CPOTST", "CPOTOTH" , "CSUGBT", "CRAPE", "CSNFL" , "CSOYA","SE046", "CARAOTHN")
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_LS_CYP.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_MX_FUELS_CYP.csv")
write.csv2(res, share_output_file)
...
CPERWOUTWINE_name <- "SE054"
CWINE_name <- "SE050"
CARAOTHALL_name <- c("CSUGBT","CRAPE", "CRYE", "CSOYA", "CARAOTHN")
CFODDOTHALL_name <- c("CFODRTBR" , "CGRSTMP", "CGRSXRG", "CRG", "CFODDOTHN")
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_MX_CYP.RDS"))
