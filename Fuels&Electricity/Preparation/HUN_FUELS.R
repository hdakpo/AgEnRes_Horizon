...
MYDATA <- readRDS("D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Fuels/input/Data_2017_2022/HUN.RDS")
...
share_output_file <- paste0(output_path, "share_GC_FUELS_HUN.csv")
...
CCROPOBS_name <- c("CMZ", "CBRL", "COAT", 
                   "CRAPE", "CSNFL", "CSOYA", "CGRSTMP", "CGRSXRG", "CRG")
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_GC_HUN.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_LS_FUELS_HUN.csv")
write.csv2(res, share_output_file)
...
CPERWOUTWINE_name <- "SE054"
CARAOTHALL_name <- c("CPOT", "CPOTST", "CPOTOTH", "CSUGBT", "CSOYA", "SE046", "SE050", "CARAOTHN")
CFODDOTHALL_name <- c("CFODRTBR", "CFODDOTHN")
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_LS_HUN.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_MX_FUELS_HUN.csv")
write.csv2(res, share_output_file)
...
CWHTALL_name <- c("CWHTC" , "CWHTD")
CCEROTHALL_name <- c( "CRYE", "CRICE", "CCEROTHN")
CARAOTHALL_name <- c("CPOT", "CPOTST", "CPOTOTH" , "CSUGBT", "CSOYA", "SE046", "SE054", "SE050", "CARAOTHN")
CFODDOTHALL_name <- c("CFODRTBR", "CFODDOTHN")
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_MX_HUN.RDS"))
