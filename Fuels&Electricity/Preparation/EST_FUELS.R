...
MYDATA <- readRDS("D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Fuels/input/Data_2017_2022/EST.RDS")
...
share_output_file <- paste0(output_path, "share_GC_FUELS_EST.csv")
...
CARAOTHALL_name <- c("CSUGBT", "SE054" , "SE046", "SE050", "CARAOTHN")
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_GC_EST.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_LS_FUELS_EST.csv")
write.csv2(res, share_output_file)
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_LS_EST.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_MX_FUELS_EST.csv")
write.csv2(res, share_output_file)
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_MX_EST.RDS"))
