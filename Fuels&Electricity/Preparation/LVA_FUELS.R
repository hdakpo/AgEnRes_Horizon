...
MYDATA <- readRDS("D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Fuels/input/Data_2017_2022/LVA.RDS")
...
Mcname_fodder <- c("CFODRTBR", "CGRSTMP", "CGRSXRG", "CRG")
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_GC_LVA.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_LS_FUELS_LVA.csv")
write.csv2(res, share_output_file)
...
CCROPOBS_name <- c( "CBRL", "COAT","CGRSTMP", "CGRSXRG", "CRG")
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_LS_LVA.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_MX_FUELS_LVA.csv")
write.csv2(res, share_output_file)
...
CCROPOBS_name <- c("CBRL", "CRYE", "COAT", "CGRSTMP", "CGRSXRG", "CRG")
...
CCEROTHALL_name <- c("CMZ", "CRICE", "CCEROTHN")
CARAOTHALL_name <- c("CSUGBT", "SE046", "SE050", "CARAOTHN")
CFODDOTHALL_name <- c("CFODRTBR",  "CFODDOTHN")
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_MX_LVA.RDS"))
