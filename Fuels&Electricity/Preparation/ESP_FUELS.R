...
MYDATA <- readRDS("D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Fuels/input/Data_2017_2022/ESP.RDS")
...
share_output_file <- paste0(output_path, "share_GC_FUELS_ESP.csv")
write.csv2(res, share_output_file)

# Regroupement pour allocation
cname_alloc_gc <- c("CWHTC", "CWHTD", "CMZ", "CBRL", "CRYE", "COAT", "CRICE", "CCEROTHN",
                    "CPOTALL", 
                    "CSUGBT", "CRAPE", "CSNFL",
                    "CVEGFLOW","CPERWOUTWINE", "CFODDOTHALL", 
                    "CARAOTHALL")

CCROPOBS_name <- c("CWHTC", "CWHTD", "CMZ", "CBRL", "CRYE", "COAT", "CRICE", "CCEROTHN",
                   "CSUGBT", "CRAPE", "CSNFL")
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_GC_ESP.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_LS_FUELS_ESP.csv")
write.csv2(res, share_output_file)
...
CPERWOUTWINE_name  <- "SE054"
CARAOTHALL_name <- c("CRAPE","CRYE", "CSNFL", "CPOT", "CPOTST", "CPOTOTH", "CSUGBT", "SE046", "SE050", "CARAOTHN")
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_LS_ESP.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_MX_FUELS_ESP.csv")
write.csv2(res, share_output_file)
...
CPERWOUTWINE_name <- "SE054"
CWINE_name <- "SE050"
CARAOTHALL_name <- c("CPOT", "CPOTST", "CPOTOTH","CSUGBT", "CRAPE", "SE046", "CSOYA", "CARAOTHN")
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_MX_ESP.RDS"))
