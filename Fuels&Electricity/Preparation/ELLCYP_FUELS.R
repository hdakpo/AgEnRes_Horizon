...
MYDATA <- readRDS("D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Fuels/input/Data_2017_2022/ELLCYP.RDS")
...
share_output_file <- paste0(share_path, "share_GC_FUELS_ELLCYP.csv")
write.csv2(res, share_output_file)

# Regroupement pour allocation
cname_alloc_gc <- c("CWHTC" , "CWHTD","CMZ", "CBRL", "CCEROTHALL",
                    "CPOT", "CPOTOTH",
                    "COILSEEDALL", 
...
CCROPOBS_name <- c("CWHTC" , "CWHTD","CMZ", "CBRL", 
                   "CPOT")
...
saveRDS(mylist_for_model, file = paste0(output_path, "prepared_objects_FUELS_GC_ELLCYP.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(share_path, "share_LS_FUELS_ELLCYP.csv")
write.csv2(res, share_output_file)
...
saveRDS(mylist_for_model, file = paste0(output_path, "prepared_objects_FUELS_LS_ELLCYP.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(share_path, "share_MX_FUELS_ELLCYP.csv")
write.csv2(res, share_output_file)

# Regroupement pour allocation
cname_alloc_mx <- c("CWHTD", "CWHTC", "CMZ", "CBRL", "CCEROTHALL",
                    "CPERWOUTWINE", "CWINE",
                    "CGRSTMP", "CGRSXRG", "CRG","CFODDOTHALL",
                    "CARAOTHALL")

CCROPOBS_name <- c( "CWHTD", "CWHTC", "CMZ", "CBRL","CGRSTMP", "CGRSXRG", "CRG")
...
CWINE_name <-"SE050"
CFODDOTHALL_name <- c("CFODRTBR", "CFODDOTHN")
CARAOTHALL_name <- c("CPOT", "CPOTST", "CPOTOTH","CSOYA", "CRAPE", "CSNFL", "CSUGBT", "SE046",  "CARAOTHN")
...
saveRDS(mylist_for_model, file = paste0(output_path, "prepared_objects_FUELS_MX_ELLCYP.RDS"))
