...
MYDATA <- readRDS("D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Fuels/input/Data_2017_2022/LUX.RDS")
...
share_output_file <- paste0(output_path, "share_GC_FUELS_LUX.csv")
...
CCROPOBS_name <- c("CBRL", "COAT", "CRYE","CSUGBT", "CGRSTMP", "CGRSXRG")

# Création des agrégées
CWHTALL_name <- c("CWHTC", "CWHTD")
CPOTALL_name <- c("CPOT", "CPOTST" , "CPOTOTH")
CCEROTHALL_name <- c("CMZ", "CRICE","CCEROTHN", "CRYE")
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_GC_LUX.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_LS_FUELS_LUX.csv")
write.csv2(res, share_output_file)
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_LS_LUX.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_MX_FUELS_LUX.csv")
write.csv2(res, share_output_file)
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_MX_LUX.RDS"))
