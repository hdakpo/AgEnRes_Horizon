...
MYDATA <- readRDS("D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Fuels/input/Data_2017_2022/DAN.RDS")
...
share_output_file <- paste0(output_path, "share_GC_FUELS_DAN.csv")
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_GC_DAN.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_LS_FUELS_DAN.csv")
write.csv2(res, share_output_file)
...
CCROPOBS_name <- c( "CBRL", "CRYE", "COAT", "CGRSTMP", "CGRSXRG")
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_LS_DAN.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_MX_FUELS_DAN.csv")
write.csv2(res, share_output_file)
...
CCROPOBS_name <- c("CBRL", "CRYE", "COAT", "CPOT", "CPOTST", "CSUGBT", "CGRSTMP", "CGRSXRG")
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_MX_DAN.RDS"))
