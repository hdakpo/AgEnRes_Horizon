...
MYDATA <- readRDS("D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Fuels/input/Data_2017_2022/BEL.RDS")
...
share_output_file <- paste0(output_path, "share_GC_FUELS_BEL.csv")
...
saveRDS(mylist_for_model, file =  paste0(share_path, "prepared_objects_FUELS_GC_BEL.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_LS_FUELS_BEL.csv")
write.csv2(res, share_output_file)
...
CCROPOBS_name <- c("CMZ", "CBRL","CSUGBT", "CGRSTMP", "CGRSXRG")

# Création des agrégées
CWHTALL_name <- c("CWHTC" , "CWHTD")
CCEROTHALL_name <- c("CRYE", "COAT", "CRICE", "CCEROTHN")
CPOTALL_name <- c("CPOT", "CPOTST", "CPOTOTH")
CARAOTHALL_name <- c("CRAPE", "CSNFL", "CSOYA", "SE046", "SE054" , "SE050", "CARAOTHN")
CFODDOTHALL_name <- c("CFODRTBR", "CRG", "CFODDOTHN")
...
share_path <- "input/Data pour outliers treat/"
saveRDS(mylist_for_model, file = paste0(share_path , "prepared_objects_FUELS_LS_BEL.RDS"))
...
# Sauvegarde des parts GC par pays
share_output_file <- paste0(output_path, "share_MX_FUELS_BEL.csv")
write.csv2(res, share_output_file)
...
CPOTALL_name <- c("CPOT", "CPOTST", "CPOTOTH")
CVEGFLOW_name <- "SE046"
CARAOTHALL_name <- c("CRAPE", "CSNFL", "CSOYA","SE054" , "SE050", "CARAOTHN")
CFODDOTHALL_name <- c("CFODRTBR", "CRG", "CFODDOTHN")
...
saveRDS(mylist_for_model, file = paste0(share_path, "prepared_objects_FUELS_MX_BEL.RDS"))
