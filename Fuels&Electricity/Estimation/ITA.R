...
output_dir <- "D:/Partage_Utilisateurs/RICA/TEST CLUSTER/Test cluster/output"
...
save(list = c("MYDATA_GC_estimation","fit","MYDATA_GC","CURRENT_COUNTRY_CODE",
     ...
     file = file.path(output_dir, paste0("output_FERT_GC_Kdec_ITA.RData")))

# Status messages
cat("✅ Terminé pour ", CURRENT_COUNTRY_CODE, " — ", output_dir, "\n", sep = "")
